...
const DetallTobillera = () => {
     const pathname = usePathname()
        ...
        const datos = DATOCOTOBILLERAS.productos.find(data => data.id === id)
    ...
    return (
        ...
        <div className="container flex items-center justify-center md:mr-0 ">
    ...
    <div className="px-5 md:pb-5 md:mt-[-40px]">
           ...
           <input  type="number"
                ...
                className="w-16 mt-2 mb-8 md:my-4  text-center border rounded-md"/>
...
export default DetallTobillera